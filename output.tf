...
output "vpc_default_network_acl_id" {
  value       = module.eks_vpc.vpc_default_network_acl_id
  description = "The ID of the network ACL created by default on VPC creation"
}

output "vpc_default_security_group_id" {
  value       = module.eks_vpc.vpc_default_security_group_id
  description = "The ID of the security group created by default on VPC creation"
}

output "vpc_default_route_table_id" {
  value       = module.eks_vpc.vpc_default_route_table_id
  description = "The ID of the route table created by default on VPC creation"
}

output "vpc_ipv6_association_id" {
  value       = module.eks_vpc.vpc_ipv6_association_id
  description = "The association ID for the IPv6 CIDR block"
}

output "vpc_ipv6_cidr_block" {
  value       = module.eks_vpc.ipv6_cidr_block
...
output "public_subnet_cidrs" {
  value       = module.eks_subnets.public_subnet_cidrs
  description = "CIDR blocks of the created public subnets"
}

output "private_subnet_cidrs" {
  value       = module.eks_subnets.private_subnet_cidrs
  description = "CIDR blocks of the created private subnets"
}

output "public_route_table_ids" {
  value       = module.eks_subnets.public_route_table_ids
  description = "IDs of the created public route tables"
}

output "private_route_table_ids" {
  value       = module.eks_subnets.private_route_table_ids
  description = "IDs of the created private route tables"
}

output "nat_gateway_ids" {
  value       = module.eks_subnets.nat_gateway_ids
  description = "IDs of the NAT Gateways created"
}

output "nat_instance_ids" {
  value       = module.eks_subnets.nat_instance_ids
...
output "availability_zones_number" {
  value       = module.eks_subnets.number_of_AZs
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
output "records_name" {
  //  value = formatlist("https://%s:31000/hazelcast-mancenter/dev", module.route53.records_name)
  value = module.route53.records_name
}

output "records_id" {
  value = element(module.route53.records_name, 1)
}
